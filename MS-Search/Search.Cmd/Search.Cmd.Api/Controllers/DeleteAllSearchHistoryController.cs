...
namespace Search.Cmd.Api.Controllers
{
    ...
    public class DeleteAllSearchHistoryController : ControllerBase
    {
        private readonly ILogger<DeleteAllSearchHistoryController> _logger;
        private readonly ICommandDispatcher _commandDispatcher;

        public DeleteAllSearchHistoryController(ILogger<DeleteAllSearchHistoryController> logger, ICommandDispatcher commandDispatcher)
        {
            _logger = logger;
        ...
        [HttpDelete]
        public async Task<ActionResult> DeleteAllSearchHistoryAsync([FromQuery] DeleteAllSearchHistoryCommand command)
        {
            try
            {    
                command.UserCode=command.UserCode;            
