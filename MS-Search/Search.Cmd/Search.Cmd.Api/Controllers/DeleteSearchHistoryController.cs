...
namespace Search.Cmd.Api.Controllers
{
    ...
    public class DeleteSearchHistoryController : ControllerBase
    {
        private readonly ILogger<DeleteSearchHistoryController> _logger;
        private readonly ICommandDispatcher _commandDispatcher;

        public DeleteSearchHistoryController(ILogger<DeleteSearchHistoryController> logger, ICommandDispatcher commandDispatcher)
        {
            _logger = logger;
