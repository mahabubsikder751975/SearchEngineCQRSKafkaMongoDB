...
namespace Search.Cmd.Api.Controllers
{
    ...
    public class NewSearchHistoryController: ControllerBase
    {
        private readonly ILogger<NewSearchHistoryController> _logger;
        private readonly ICommandDispatcher _commandDispatcher;

        public NewSearchHistoryController(ILogger<NewSearchHistoryController> logger, ICommandDispatcher commandDispatcher)
        {
            _logger = logger;
         ...
         [HttpPost]
        public async Task<ActionResult> NewPostAsync(NewSearchHistoryCommand command)
        {
            //Generate a new Id
            var id = Guid.NewGuid();
            try
